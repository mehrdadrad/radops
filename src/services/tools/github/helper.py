...
def get_github_repo(user_id: str):
    ...
    try:
        ...
        github_org = credentials.get('github_org', settings.github.default_org)
        github_repo = credentials.get('github_repo', settings.github.default_repo)
