...
User: "Can you research the latest features in Cisco IOS?"

1. Check available skills -> See "cisco-docs" skill with its path
2. Read the skill using the path shown
3. Follow the skill's research workflow (search -> organize -> synthesize)
4. Use any helper inline or file scripts with absolute paths
